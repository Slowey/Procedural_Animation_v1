...
static class SQUAD (): 	
	...
	def Spline(quaternions as (Quaternion), t as single):
		section as int = (quaternions.Length) * t
		alongLine as single = (quaternions.Length) * t - section
		if section == 0:
			return SplineSegment(quaternions[section+3], quaternions[section], quaternions[section+1], quaternions[section+2], alongLine)
		if section == 1:
			return SplineSegment(quaternions[section-1], quaternions[section], quaternions[section+1], quaternions[section+2], alongLine)
		if section == 2:
			return SplineSegment(quaternions[section-1], quaternions[section], quaternions[section+1], quaternions[section-2], alongLine)
		if section == 3:
			return SplineSegment(quaternions[section-1], quaternions[section], quaternions[section-3], quaternions[section-2], alongLine)
